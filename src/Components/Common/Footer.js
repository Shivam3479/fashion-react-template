        ...
        <footer className="footer__section bg__black">
            <div className="container-fluid">
                <div className="main__footer d-flex justify-content-between">
                    <div className="footer__widget footer__widget--width">
                        ...
                        <div className="footer__widget--inner">
                            <p className="footer__widget--desc text-ofwhite mb-20">Lorem ipsum dolor sit amet, consectetur
                            ...
                            <div className="footer__social">
                                ...
                                <ul className="social__shear d-flex">
                                    <li className="social__shear--list">
                                        <a className="social__shear--list__icon" target="_blank"
                    ...
                    <div className="footer__widget--menu__wrapper d-flex footer__widget--width">
                        <div className="footer__widget">
                            ...
                            <ul className="footer__widget--menu footer__widget--inner">
                                <li className="footer__widget--menu__list"><a className="footer__widget--menu__text"
                        ...
                        <div className="footer__instagram footer__widget--inner">
                            <div className="footer__instagram--list d-flex">
                                <div className="instagram__thumbnail">
                                    <a className="instagram__thumbnail--img" target="_blank"
                    ...
                    <div className="footer__widget footer__widget--width">
                        ...
                        <div className="footer__widget--inner">
                            <p className="footer__widget--desc text-ofwhite m-0">Fill their seed open meat. Sea you <br /> great
                                Saw image stl</p>
                            <div className="newsletter__subscribe">
                                <form className="newsletter__subscribe--form" action="#">
                                    <label>
                                        <input className="newsletter__subscribe--input" placeholder="Email Address"
                                            type="email" />
                                    </label>
                ...
                <div className="footer__bottom d-flex justify-content-between align-items-center">
                    <p className="copyright__content text-ofwhite m-0">Copyright &copy; {new Date().getFullYear()} <a className="copyright__content--link"
                            href="index.html">XYZ</a>. All Rights Reserved.Design By Company
                    </p>
