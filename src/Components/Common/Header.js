    ...
    return (<>
       <header className="header__section">
                ...
                <div className="header__topbar--inner d-flex align-items-center justify-content-between">
                    <div className="header__shipping">
                        <ul  className="header__shipping--wrapper d-flex">
                            <li className="header__shipping--text text-white">Welcome to XYZ online Store</li>
                            <li className="header__shipping--text text-white d-sm-2-none"><img
                                    className="header__shipping--text__icon" src="assets/img/icon/bus.png" alt="bus-icon"/>
                                Track Your Order</li>
                            <li className="header__shipping--text text-white d-sm-2-none"><img
                                    className="header__shipping--text__icon" src="assets/img/icon/email.png"
                                    alt="email-icon"/> <a className="header__shipping--text__link"
                        ...
                        <ul className="d-flex align-items-center">
                            <li className="language__currency--list">
                                <a className="language__switcher text-white" href="#">
                                    <img className="language__switcher--icon__img" src="assets/img/icon/language-icon.png"
                                        alt="currency"/>
                                    <span>English</span>
                ...
                <div className="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    <div className="offcanvas__header--menu__open ">
                        <a className="offcanvas__header--menu__open--btn" href="javascript:void(0)" data-offcanvas>
                            <svg xmlns="http://www.w3.org/2000/svg" className="ionicon offcanvas__header--menu__open--svg"
                                viewBox="0 0 512 512">
                    ...
                    <div className="main__logo">
                        <h1 className="main__logo--title"><NavLink className="main__logo--link" to="/"><img
                                    className="main__logo--img" src="assets/img/logo/nav-log.png" alt="logo-img"/></NavLink></h1>
                    </div>
                        ...
                        <form className="d-flex header__search--form" action="#">
                            <div className="header__select--categories select">
                                <select className="header__select--inner">
                                    <option selected defaultValue="1">All Categories</option>
                                    <option defaultValue="2">Accessories</option>
                                    <option defaultValue="3">Accessories & More</option>
                                    <option defaultValue="4">Camera & Video </option>
                                    <option defaultValue="5">Butters & Eggs </option>
                                </select>
                            </div>
                            <div className="header__search--box">
                                ...
                                <button className="header__search--button bg__secondary text-white" type="submit"
                                    ...
                                    <svg className="header__search--button__svg" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <path fill="none" stroke="currentColor" strokeLinecap="round"
                                            strokeMiterlimit="10" strokeWidth="32" d="M338.29 338.29L448 448"></path>
                                    </svg>
                                </button>
                            </div>
                        </form>
                    ...
                    <div className="header__account header__sticky--none">
                        <ul className="d-flex">
                            ...
                            <li className="header__account--items d-none d-lg-block">
                                <NavLink className="header__account--btn" to="/wishlist">
                            ...
                            <li className="header__account--items">
                                <NavLink className="header__account--btn minicart__open--btn" to="/cart"
                                    data-offcanvas>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443"
                    ...
                    <div className="header__menu d-none header__sticky--block d-lg-block">
                        <nav className="header__menu--navigation">
                            <ul className="d-flex">
                                ...
                                <li className="header__menu--items style2">
                                    <NavLink className="header__menu--link" to="/about-us">About US </NavLink>
                                </li>
                                <li className="header__menu--items mega__menu--items style2">
                                    <NavLink className="header__menu--link" to="/product">Shop</NavLink>                                   
                                </li>                                
                                <li className="header__menu--items style2">
                                    <a className="header__menu--link" href="blog.html">Blog
                                        <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12"
                                    ...
                                    <ul className="header__sub--menu">
                                        <li className="header__sub--menu__items"><a href="blog.html"
                                                className="header__sub--menu__link">Blog Grid</a></li>
                                        <li className="header__sub--menu__items"><a href="blog-details.html"
                                                className="header__sub--menu__link">Blog Details</a></li>
                                        <li className="header__sub--menu__items"><a href="blog-left-sidebar.html"
                                                className="header__sub--menu__link">Blog Left Sidebar</a></li>
                                        <li className="header__sub--menu__items"><a href="blog-right-sidebar.html"
                                                className="header__sub--menu__link">Blog Right Sidebar</a></li>
                                    </ul>
                                </li>
        ...
        <div className="header__bottom">
            <div className="container-fluid">
                <div
                    className="header__bottom--inner position__relative d-none d-lg-flex justify-content-between align-items-center">
                        ...
                        <nav className="header__menu--navigation">
                            <ul className="d-flex">
                                ...
                                <li className="header__menu--items mega__menu--items">
                                    <NavLink className="header__menu--link" to="/product">Shop
                                        {/* <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12"
                                            height="7.41" viewBox="0 0 12 7.41">
                                            <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z"
                                                transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                    ...
                    <p className="header__discount--text"><img className="header__discount--icon__img"
                            src="assets/img/icon/lamp.png" alt="lamp-img"/> Special up to 60% Off all item</p>
                </div>
            </div>
        </div>
                    ...
                    <ul className="offcanvas__menu_ul">
                        <li className="offcanvas__menu_li">
                            ...
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><a href="index.html"
                                        className="offcanvas__sub_menu_item">Home One</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-2.html"
                                        className="offcanvas__sub_menu_item">Home Two</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="index-3.html"
                                        className="offcanvas__sub_menu_item">Home Three</a></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
                            ...
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li">
                                    ...
                                    <ul className="offcanvas__sub_menu">
                                        <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item"
                        ...
                        <li className="offcanvas__menu_li">
                            ...
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><a href="blog.html"
                                        className="offcanvas__sub_menu_item">Blog Grid</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="blog-details.html"
                                        className="offcanvas__sub_menu_item">Blog Details</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="blog-left-sidebar.html"
                                        className="offcanvas__sub_menu_item">Blog Left Sidebar</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="blog-right-sidebar.html"
                                        className="offcanvas__sub_menu_item">Blog Right Sidebar</a></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li">
                            <a className="offcanvas__menu_item" href="#">Pages</a>
                            <ul className="offcanvas__sub_menu">
                                <li className="offcanvas__sub_menu_li"><a href="about.html"
                                        className="offcanvas__sub_menu_item">About Us</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="contact.html"
                                        className="offcanvas__sub_menu_item">Contact Us</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="cart.html"
                                        className="offcanvas__sub_menu_item">Cart Page</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="portfolio.html"
                                        className="offcanvas__sub_menu_item">Portfolio Page</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="wishlist.html"
                                        className="offcanvas__sub_menu_item">Wishlist Page</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="login.html"
                                        className="offcanvas__sub_menu_item">Login Page</a></li>
                                <li className="offcanvas__sub_menu_li"><a href="404.html"
                                        className="offcanvas__sub_menu_item">Error Page</a></li>
                            </ul>
                        </li>
                        <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="about.html">About</a></li>
                        <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" href="contact.html">Contact</a>
                        </li>
                    </ul>
        ...
        <div className="offCanvas__minicart">
                    ...
                    <div className="minicart__text">
                        ...
                        <div className="minicart__text--footer d-flex align-items-center">
                            <div className="quantity__box minicart__quantity">
                                <button type="button" className="quantity__value decrease" aria-label="quantity value"
                                    defaultValue="Decrease Value">-</button>
                                <label htmlFor="">
                                    <input type="number" className="quantity__number" defaultValue="1" data-counter />
                                </label>
                                <button type="button" className="quantity__value increase" defaultValue="Increase Value">+</button>
                            </div>
                    ...
                    <div className="minicart__text">
                        ...
                        <div className="minicart__text--footer d-flex align-items-center">
                            <div className="quantity__box minicart__quantity">
                                ...
                                <button type="button" className="quantity__value increase" aria-label="quantity value"
                                    defaultValue="Increase Value">+</button>
                            </div>
                            <button className="minicart__product--remove">Remove</button>
                        </div>
                    </div>
            ...
            <div className="minicart__conditions text-center">
                ...
                <label className="minicart__conditions--label" for="accept">I agree with the <a
                        className="minicart__conditions--link" href="privacy-policy.html">Privacy and Policy</a></label>
            </div>
        ...
        <div className="predictive__search--box ">
            <div className="predictive__search--box__inner">
                ...
                <form className="predictive__search--form" action="#">
                    ...
                    <button className="predictive__search--button" aria-label="search button" type="submit"><svg
                            className="header__search--button__svg" xmlns="http://www.w3.org/2000/svg" width="30.51"
            ...
            <button className="predictive__search--close__btn" aria-label="search close button" data-offcanvas>
                <svg className="predictive__search--close__icon" xmlns="http://www.w3.org/2000/svg" width="40.51"
