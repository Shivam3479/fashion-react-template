                    ...
                    <div className="row row-cols-1 align-items-center">
                        <div className="col">
                            <div className="deals__banner--content position__relative">
                                <span className="deals__banner--content__subtitle text__secondary">Hurry up and Get 25%
                                    Discount</span>
                                <h2 className="deals__banner--content__maintitle">Deals Of The Day</h2>
                                <p className="deals__banner--content__desc">Lorem ipsum dolor sit amet, consectetur
                                    adipisicing elit, <br/> sed do eiusmod tempor incididunt ut labore </p>
                                <div className="deals__banner--countdown d-flex" data-countdown="Sep 30, 2025 00:00:00">
                                </div>
                                <a className="primary__btn" href="shop.html">Show Collection
                                    <svg className="primary__btn--arrow__icon" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="banner__bideo--play">
                                    <a className="banner__bideo--play__icon glightbox" href="https://vimeo.com/115041822"
                                        data-gallery="video">
