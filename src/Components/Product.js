                    ...
                    <div className="product__view--mode d-flex align-items-center">
                        ...
                        {/* <div className="product__view--mode__list">
                            <div className="product__grid--column__buttons d-flex justify-content-center">
                                <button className="product__grid--column__buttons--icons active"
                                ...
                                <button className="product__grid--column__buttons--icons" aria-label="product list button"
                                            ...
                                            <div className="col mb-30">
                                                <div className="product__items ">
                                                    ...
                                                    <div className="product__items--content">
                                                        <span className="product__items--content__subtitle">Jacket,
                                                            Women</span>
                                                        ...
                                                        <ul className="product__items--action d-flex">
                                                            <li className="product__items--action__list">
                                                                <a className="product__items--action__btn add__to--cart"
                                                                    ...
                                                                    <span className="add__to--cart__text"> + Add to
                                                                        cart</span>
                                                                </a>
                                                            </li>
                                                            <li className="product__items--action__list">
                                                                <a className="product__items--action__btn"
                                                                    href="wishlist.html">
                                                                    <svg className="product__items--action__btn--svg"
                            ...
                            <div className="pagination__area bg__gray--color">
                                <nav className="pagination justify-content-center">
                                    <ul className="pagination__wrapper d-flex align-items-center justify-content-center">
                                        ...
                                        <li className="pagination__list"><a href="shop.html"
