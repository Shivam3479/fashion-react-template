                ...
                <div className="row mb--n28">
                    <div className="col-lg-5 col-md-order mb-28">
                        <div className="banner__items">
                            <a className="banner__items--thumbnail position__relative" href="shop.html"><img
                                    className="banner__items--thumbnail__img" src="assets/img/banner/banner1.png"
                                    alt="banner-img"/>
                                <div className="banner__items--content">
                                    ...
                                    <span className="banner__items--content__link">View Discounts
                                        <svg className="banner__items--content__arrow--icon"
                    ...
                    <div className="col-lg-7 mb-28">
                        <div className="row row-cols-lg-2 row-cols-sm-2 row-cols-1">
                            <div className="col mb-28">
                                <div className="banner__items">
                                    <a className="banner__items--thumbnail position__relative" href="shop.html"><img
                                            className="banner__items--thumbnail__img" src="assets/img/banner/banner2.png"
                                            alt="banner-img"/>
                                        <div className="banner__items--content">
                                            <span className="banner__items--content__subtitle text__secondary">Shop
                                                Women</span>
                            ...
                            <div className="col mb-28">
                                <div className="banner__items">
                                    <a className="banner__items--thumbnail position__relative" href="shop.html"><img
                                            className="banner__items--thumbnail__img" src="assets/img/banner/banner3.png"
                                            alt="banner-img"/>
                                        <div className="banner__items--content">
